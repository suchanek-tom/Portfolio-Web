    ...
    return(
        <div className=" lg:h-screen">
            ...
            <div className=" mt-4 px-12 lg:flex lg:ml-12 text-xl md:text-2xl md:justify-center">
                <div className=" md:w-fit border-2 border-white p-1 m-1 rounded hover:bg-white hover:text-black hover:font-semibold duration-500 cursor-pointer flex align-middle items-center ">
                    HTML <SiHtml5 className="mx-auto md:ml-2" />
                </div>
                <div className=" md:w-fit border-2 border-white p-1 m-1 rounded hover:bg-white hover:text-black hover:font-semibold duration-500 cursor-pointer flex align-middle items-center">
                    CSS <SiCss3 className="mx-auto md:ml-2" />
                </div>
                <div className="md:w-fit border-2 border-white p-1 m-1 rounded hover:bg-white hover:text-black hover:font-semibold duration-500 cursor-pointer flex align-middle items-center">
                    Javascript <SiJavascript className="mx-auto md:ml-2" />
                </div>
                <div className="md:w-fit border-2 border-white p-1 m-1 rounded hover:bg-white hover:text-black hover:font-semibold duration-500 cursor-pointer flex align-middle items-center">
                    React <SiReact className="mx-auto md:ml-2" />
                </div>
                <div className="md:w-fit border-2 border-white p-1 m-1 rounded hover:bg-white hover:text-black hover:font-semibold duration-500 cursor-pointer flex align-middle items-center">
                    Tailwindcss <SiTailwindcss className="mx-auto md:ml-2" />
                </div>
                <div className="md:w-fit border-2 border-white p-1 m-1 rounded hover:bg-white hover:text-black hover:font-semibold duration-500 cursor-pointer flex align-middle items-center">
                    PHP <SiPhp className="mx-auto md:ml-2" />
                </div>
                <div className="md:w-fit border-2 border-white p-1 m-1 rounded hover:bg-white hover:text-black hover:font-semibold duration-500 cursor-pointer flex align-middle items-center">
                    Symfony <SiSymfony className="mx-auto md:ml-2" />
                </div>
                <div className="md:w-fit border-2 border-white p-1 m-1 rounded hover:bg-white hover:text-black hover:font-semibold duration-500 cursor-pointer flex align-middle items-center">
                    Git <BsGit className="mx-auto md:ml-2" />
                </div>
                <div className="md:w-fit border-2 border-white p-1 m-1 rounded hover:bg-white hover:text-black hover:font-semibold duration-500 cursor-pointer flex align-middle items-center">
                     GitHub <SiGithub className="mx-auto md:ml-2" />
                </div>
            </div>
